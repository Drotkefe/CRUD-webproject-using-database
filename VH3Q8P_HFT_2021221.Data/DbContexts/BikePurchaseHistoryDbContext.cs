...
namespace VH3Q8P_HFT_2021221.Data.DbContexts
{
    public class BikePurchaseHistoryDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //Bikes
            var bike1 = new Bike() { Id = 1, Model_Name = "Spartan 2015 CF", Price = 5, BrandId = 2, RiderId = 1 };
            var bike2 = new Bike() { Id = 2, Model_Name = "Troy 2017 CF", Price = 4, BrandId = 2, RiderId = 2 };
            var bike3 = new Bike() { Id = 3, Model_Name = "Session 2016 9 X01", Price = 7, BrandId = 1, RiderId = 3 };
            var bike4 = new Bike() { Id = 4, Model_Name = "Remedy 2018 X01", Price = 7, BrandId = 1, RiderId = 2 };
            var bike5 = new Bike() { Id = 5, Model_Name = "Capra 2018 CF", Price = 6, BrandId = 3, RiderId = 2 };
            var bike6 = new Bike() { Id = 6, Model_Name = "Tues 2017 AL", Price = 4, BrandId = 3, RiderId = 2 };
            var bike7 = new Bike() { Id = 7, Model_Name = "Enduro 2019 CF", Price = 9, BrandId = 4, RiderId = 3 };
            var bike8 = new Bike() { Id = 8, Model_Name = "RockHopper 2016 CF", Price = 2, BrandId = 4, RiderId = 3 };
            var bike9 = new Bike() { Id = 9, Model_Name = "TURBO LEVO SL", Price = 14, BrandId = 4, RiderId = 2 };
